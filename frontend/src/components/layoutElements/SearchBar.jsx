...
const SearchBar = ({ placeholder = "Szukaj...", selectedProject, setSelectedProject }) => {
  ...
  return (
    <div ref={wrapperRef} className="w-full justify-center items-center flex flex-col gap-2 relative">
      <div
      ...
      {open && (
        <div className="absolute -mt-5 top-full  w-full sm:w-2/4 md:w-3/4 bg-[#1e1f1f] border border-[#374b4b] border-t-0 rounded-b-xl shadow-xl z-9">
