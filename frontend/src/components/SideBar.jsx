  ...
  return (
    ...
    >
      <div className="my-7 w-full">
        <img src={assets.avatar} alt="user avatar" className="w-13 rounded-full mx-auto" />
        <h1 className="text-center mt-1">User Name</h1>
...
<img src={assets.avatar} alt="avatar" className='w-8 rounded-full' />
<div>
...
<LogOut onClick={()=>navigate('/ai/logout')} className='w-4.5 text-gray-400 hover:text-gray-700 transition cursor-pointer'/>
</div>
